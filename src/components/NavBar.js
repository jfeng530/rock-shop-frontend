...
export class NavBar extends Component {
  ...
  render() {
    return (
      <nav style={{borderBottom: "solid", borderWidth: "1px", borderColor: "#929ca7", paddingBottom: "25px", textAlign: "Center", fontSize: "25px", marginTop:"3%", fontFamily: "Courier New, Monospace", fontWeight: "100", color: "#343a40", 
